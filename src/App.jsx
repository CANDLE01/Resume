  ...
  const applyTemplate = useCallback(name=>{
    ...
    if(name==="creative"){
      setBlocks([
        ...
        {id:uid(),page:0,x:100,y:170,w:594,h:20,z:LAYER_TOP,type:"text",html:"<div style='text-align:center'><span style='font-size:11px;font-family:\"DM Sans\",sans-serif;color:#9a3412;letter-spacing:2px;text-transform:uppercase'>Designer & Developer</span></div>"},
...
if(name==="nordic"){
      setBlocks([
        ...
        {id:uid(),page:0,x:40,y:590,w:200,h:40,z:LAYER_TOP,type:"text",html:"<div><span style='font-size:12px;font-family:\"Helvetica Neue\",sans-serif;font-weight:700;color:#0f172a;text-transform:uppercase;letter-spacing:1px'>Education</span></div>"},
        {id:uid(),page:0,x:280,y:590,w:474,h:60,z:LAYER_TOP,type:"text",html:"<div style='line-height:1.6;font-size:12px;font-family:\"DM Sans\",sans-serif;color:#334155'><b>M.Sc. Human-Computer Interaction</b><br>Aalborg University (2017 – 2019)</div>"},
        {id:uid(),page:0,x:40,y:670,w:200,h:40,z:LAYER_TOP,type:"text",html:"<div><span style='font-size:12px;font-family:\"Helvetica Neue\",sans-serif;font-weight:700;color:#0f172a;text-transform:uppercase;letter-spacing:1px'>Languages</span></div>"},
        {id:uid(),page:0,x:280,y:670,w:474,h:80,z:LAYER_TOP,type:"languages",color:"#0f172a",lineColor:"#f1f5f9",items:[{lang:"Danish",level:"Native"},{lang:"English",level:"Fluent / C2"},{lang:"Swedish",level:"Professional"}]}
      ]);return;
    }
    ...
    if(name==="neon"){
      setBlocks([
        ...
        {id:uid(),page:0,x:40,y:580,w:340,h:30,z:LAYER_TOP,type:"text",html:"<div style='border-bottom:1px solid #1e293b;padding-bottom:4px'><span style='font-size:14px;font-family:\"Montserrat\",sans-serif;font-weight:700;color:#f43f5e;letter-spacing:1px'>CERTIFICATIONS</span></div>"},
        {id:uid(),page:0,x:40,y:630,w:340,h:80,z:LAYER_TOP,type:"text",html:"<div style='line-height:1.6;font-family:\"Montserrat\",sans-serif;font-size:12px;color:#94a3b8'>[✓] Certified Ethical Hacker (CEH)<br>[✓] AWS Certified Security - Specialty<br>[✓] CompTIA Security+</div>"},
        {id:uid(),page:0,x:400,y:580,w:354,h:30,z:LAYER_TOP,type:"text",html:"<div style='border-bottom:1px solid #1e293b;padding-bottom:4px'><span style='font-size:14px;font-family:\"Montserrat\",sans-serif;font-weight:700;color:#f43f5e;letter-spacing:1px'>CONTACT PROTOCOL</span></div>"},
        {id:uid(),page:0,x:400,y:630,w:354,h:80,z:LAYER_TOP,type:"social",dir:"column",align:"flex-start",color:"#ffffff",items:[{icon:"email",text:"mercer.secure@mail.com",url:"#"},{icon:"github",text:"github.com/alex-mercer",url:"#"},{icon:"location",text:"Neo-Seattle, Sector 4",url:"#"}]}
      ]);return;
    }
    ...
    if(name==="infographic"){
      setBlocks([
        ...
        {id:uid(),page:0,x:40,y:570,w:340,h:40,z:LAYER_TOP,type:"text",html:"<div style='border-bottom:2px solid #e2e8f0;padding-bottom:4px'><span style='font-size:14px;font-family:\"Raleway\",sans-serif;font-weight:700;color:#1e293b;text-transform:uppercase'>Certifications</span></div>"},
        {id:uid(),page:0,x:40,y:630,w:340,h:100,z:LAYER_TOP,type:"iconrow",items:[{icon:"file",text:"Google Data Analytics Certificate"},{icon:"file",text:"Tableau Desktop Specialist"},{icon:"file",text:"AWS Certified Cloud Practitioner"}]},
        {id:uid(),page:0,x:400,y:570,w:354,h:40,z:LAYER_TOP,type:"text",html:"<div style='border-bottom:2px solid #e2e8f0;padding-bottom:4px'><span style='font-size:14px;font-family:\"Raleway\",sans-serif;font-weight:700;color:#1e293b;text-transform:uppercase'>Interests</span></div>"},
        {id:uid(),page:0,x:400,y:630,w:354,h:80,z:LAYER_TOP,type:"hobbies",bgColor:"#f0f9ff",color:"#0ea5e9",borderColor:"#bae6fd",round:true,items:[{icon:"art",label:"Infographic Art"},{icon:"game",label:"Puzzle Games"},{icon:"web",label:"Tech Blogging"}]}
      ]);return;
    }
